...
type Props = NativeStackScreenProps<HomeStackParamList, 'NatoFlashcards'>;

export default function NatoFlashcardsScreen({ navigation }: Props) {
    ...
    <GradientBackground>
      <View style={[styles.container, { paddingTop: insets.top + SPACING.sm }]}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>NATO Flashcards</Text>
...
const styles = StyleSheet.create({
  ...
  wordText: { fontSize: 36, fontWeight: '800', color: COLORS.text },
